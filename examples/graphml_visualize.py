...
if __name__ == "__main__":
    graphml_file = r"/nano-graphrag/nano_graphrag_history2/graph_chunk_entity_relation.graphml"  # replace with your GraphML file path
    html_path = "/nano-graphrag/examples/benchmarks/graph_visualization.html"
